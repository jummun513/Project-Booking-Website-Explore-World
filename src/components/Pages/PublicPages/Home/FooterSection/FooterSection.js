...
const FooterSection = () => {
    ...
    return (
        <div className='relative top-60 md:top-36 bg-black pt-10 md:pt-48 pb-3 md:pb-5'>
            <div className="absolute top-16 w-full hidden md:block">
                <nav className="relative max-w-screen-xl mx-auto">
                    <div className="flex flex-wrap items-center justify-between mx-auto border-b-2 pb-2 border-gray-500">
                        <button type='button' className='md:order-2 border-2 p-2 rounded-full'><BsSearch className='text-white'></BsSearch></button>
                        <div className='items-center justify-between w-full md:flex md:w-auto md:order-1'>
                            <ul className="md:flex text-white font-medium">
                                {navigation.map((item) => (
                                    <li id='sidebar' key={item.name}>
                                        <NavLink to={item.href} className="relative p-3 md:mr-5 footer-nav-text hover:text-[#ff7f00] font-semibold ease-linear duration-150">
                                            {item.name}
                                        </NavLink>
                                    </li>
                                ))}
            ...
            <footer className="p-4">
                <div className="mx-auto max-w-screen-xl">
                    ...
                    <div className="flex md:flex-row flex-col-reverse items-center justify-between">
                        <p className="text-sm text-gray-500 sm:text-center dark:text-gray-400">Developed By <a href="/" className="hover:underline text-[#ff7f00]">Jummun Islam</a></p>
