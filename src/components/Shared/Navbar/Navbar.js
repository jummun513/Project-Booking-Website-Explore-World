        ...
        <div className='absolute top-0 px-2 md:px-0 w-full'>
            <div className="bg-transparent relative max-w-screen-xl mx-auto z-50 flex items-center justify-between py-5">
                <div className='md:flex justify-between md:w-1/3'>
                    ...
                    <p className="text-sm text-gray-200 hover:underline ease-linear duration-150"><a href="/" className="">jummunislam513@gmail.com</a></p>
                </div>
            ...
            <hr className="bg-transparent relative max-w-screen-xl my-6 mx-auto border-[#ff7f00] md:my-8 md:z-50" />
        </div>
    );
};
